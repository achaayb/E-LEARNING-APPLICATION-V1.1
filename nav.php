<nav class="d-inline-block position-relative" style="background-color: #FAFFC1; height: 100vh; width: 250px;">
            ...
            <h2 class="h5 mt-3 text-center">Admin name</h2>
            ...
            <ul class="list-unstyled mt-5 mx-auto text-center w-75">
                ...
                <li  style="bottom : 10px;" class="position-absolute mt-3 mx-auto w-75"><a class="d-block rounded py-2 fw-bold text-dark text-decoration-none" href="signin.php">Logout <ion-icon name="log-out-outline"></ion-icon></a></li>
            </ul>
